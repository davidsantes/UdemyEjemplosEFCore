...
{
    public partial class EFCorePeliculasDB_07_MigracionesContext : DbContext
    {
        public EFCorePeliculasDB_07_MigracionesContext()
        {
        }

        public EFCorePeliculasDB_07_MigracionesContext(DbContextOptions<EFCorePeliculasDB_07_MigracionesContext> options)
            : base(options)
        {
        }
